//
//  ToDetailCategoryViewController.swift
//  Closet
//
//  Created by 佐藤駿樹 on 2021/01/12.
//

import UIKit

class ToDetailCategoryViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let perVC = perNC.viewControllers[perNC.viewControllers.count - 3] as! PostClothesViewController
